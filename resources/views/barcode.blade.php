<html>	
	...
	<div style="text-align: center;">
		<img src="data:image/png;base64,{{DNS1D::getBarcodePNG('1710114023640000', 'C39',1,35,array(0,0,0), true)}}" alt="barcode" /><br><br>
		<!-- <img src="data:image/png;base64,{{DNS2D::getBarcodePNG('1710114023640001', 'PDF417')}}" alt="barcode" /><br><br> -->
